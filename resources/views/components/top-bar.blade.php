    ...
    <div class="topbar-column"><a class="hidden-md-down" href="#"><i class="icon-download"></i>&nbsp; دریافت اپ
        ...
        <div class="lang-currency-switcher-wrap">
            <div class="lang-currency-switcher dropdown-toggle"><span class="language"><img alt="English"
                                                                                            src="/unishop-theme/img/flags/FA.png"></span><span
                    class="currency">تومان</span></div>
            <div class="dropdown-menu">
                <a class="dropdown-item" href="#"><img src="/unishop-theme/img/flags/GB.png" alt="Deutsch">English</a>
                <a class="dropdown-item" href="#"><img src="/unishop-theme/img/flags/FR.png" alt="Français">Français</a>
                <a class="dropdown-item" href="#"><img src="/unishop-theme/img/flags/IT.png" alt="Italiano">Italiano</a>
            </div>
        </div>
    </div>
</div>
